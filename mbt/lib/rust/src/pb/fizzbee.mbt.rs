...
pub mod value {
    ...
    pub enum Kind {
        ...
        /// Sentinel for flexible state matching
        #[prost(enumeration = "super::SentinelType", tag = "6")]
        SentinelValue(i32),
...
pub struct InitRequest {
    ...
    #[prost(message, optional, tag = "3")]
    pub options: ::core::option::Option<ExecOptions>,
    /// Indicates if this is a fuzzing/simulation-guided test run
    #[prost(bool, tag = "4")]
    pub is_fuzzing: bool,
    /// Random seed for reproducible fuzzing (only used when is_fuzzing is true)
    #[prost(int64, tag = "5")]
    pub fuzz_seed: i64,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct InitResponse {
    ...
    /// Variable overrides provided by the model
    #[prost(map = "string, message", tag = "5")]
    pub overrides: ::std::collections::HashMap<::prost::alloc::string::String, Value>,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
impl SentinelType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::SentinelUnspecified => "SENTINEL_UNSPECIFIED",
            Self::SentinelIgnore => "SENTINEL_IGNORE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "SENTINEL_UNSPECIFIED" => Some(Self::SentinelUnspecified),
            "SENTINEL_IGNORE" => Some(Self::SentinelIgnore),
            _ => None,
        }
    }
}
